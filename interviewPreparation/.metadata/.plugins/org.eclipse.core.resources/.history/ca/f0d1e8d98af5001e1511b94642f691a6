...
public class ConstructorRunnerClass {
	
	public static void main(String[] args) {
		
		ConstructorRunnerClass reference=new ConstructorRunnerClass();
		...
		System.out.println("Native Place->"+reference2.nativePlace);// Here we can observe static variable also can be acessed through reference.
		System.out.println("Calling through class name=>"+Constructorss.nativePlace);// This static variable we are calling with the class name.
		...
		Constructorss reference4=new Constructorss("VijayaDurga", 16, "Nellore");
 		...
 		System.out.println("Salary=>"+reference3.salary);// Here as salary is a instance variable even though we haven't initialised in as a parameter in constructor we can get it though help of reference.
 		
 		System.out.println("------------------------4 nd method of constructors------------------------------");
		Constructorss reference5=new Constructorss();
		System.out.println("Native calling from instance==>"+Constructorss.nativePlace);// Before changing static value.
		...
		// Here in the constructors once we change the value to the instance or static variable it will automatically change.
